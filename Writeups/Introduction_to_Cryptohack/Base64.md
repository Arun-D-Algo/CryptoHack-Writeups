...
Another common encoding scheme is Base64, which represents binary data as an ASCII string using an alphabet of 64 characters.

The challenge provides a hexadecimal string and requires first decoding it into bytes, then encoding those bytes into Base64 to obtain the flag.
